...
{
    return(
        <div style={{backgroundColor : 'white', minHeight:'100vh', textAlign : 'center', backgroundImage:'url(\'images/7.jpg\')', backgroundRepeat:'no-repeat',backgroundSize:'cover', backgroundPosition:'center'}}>
            <Navbar />
            <br />
            <br />
