...
function RoomAvailability() {
  ...
  return (
    ...
    {hotel && (
        <div style={{ width: '46%', height: 'auto', padding: '30px', backgroundColor: 'rgba(247,14,14,0.79)', borderRadius: '8px', boxShadow: '0 0 20px rgba(51, 255, 0, 0.8), 0 0 30px rgba(255, 115, 0, 0.6)' }}>
            <h2>{hotel.name}</h2>
